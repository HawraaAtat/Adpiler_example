        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="sidebarCollapse">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('team-members')}}">
                            <i class="bi bi-chat"></i> Team members
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('upload-files')}}">
                            <i class="bi bi-cloud-arrow-up"></i> Upload files
                            {{-- <span class="badge bg-soft-primary text-primary rounded-pill d-inline-flex align-items-center ms-auto">6</span> --}}
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('social-ads')}}">
                            <i class="bi bi-megaphone"></i> Create social ads
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('add_on')}}">
